...
<div class="row" style="    margin: 80px 30px; direction: rtl;">
    ...
    color: white;">
                                ...
                                <th style="text-align: center;">وصف البرنامج  </th>
                            ...
                            <td>{{$i++}}</td>
                                <td><i class="fa-solid fa-folder"></i> </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('bank_trainer/get_course_trainer',$call->id)}}" class="btn btn-sm" style="color: #686363; border-color: #686363;" target="_blank">open</a>

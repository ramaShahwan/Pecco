...
<td>   <a href="gender/{{$call->id}}" class="btn btn-sm btn-{{$call->tr_users_status ? 'success' : 'danger'}}">
    {{$call->tr_users_status ? 'فعالة' : 'غير فعالة'}}
        ...
        <div class="popup" id="popup-1">
            ...
            <div class="content">
                ...
                <h4 class="h44">اضافة   جنس جديد</h4>

                </div>
                <!-- <div class="containerr"> -->
                <form id="myForm" action="{{url('gender/store')}}" method="post" enctype="multipart/form-data" style="padding: 20px;color: black;">
                @csrf
                      <div class="roww">
                        <!-- <h4>جنس جديد </h4> -->
                        ...
                        <div class="input-groupp input-groupp-icon">
                          ...
                          <input type="text" placeholder=" الاسم باللغة العربية" name="tr_users_gender_name_ar" class="@error('tr_users_gender_name_ar') is-invalid @enderror"  value="{{ old('tr_users_gender_name_ar') }}"/>
                      ...
                      <span class="invalid-feedback"></span>
                        ...
                        <div class="input-groupp input-groupp-icon">
                          <input type="text" placeholder="الاسم باللغة الانكليزية" name="tr_users_gender_name_en" class="@error('tr_users_gender_name_en') is-invalid @enderror"  value="{{ old('tr_users_degree_name_en') }}"/>
                          <div class="input-icon"><i class="fa-solid fa-signature"></i></div>
        ...
        <div class="popup" id="popuppo-1">
         ...
         <div class="gf">
                ...
                <h4 class="h44">   تعديل بيانات الجنس</h4>

                </div>
         @if(isset($call))
         <form id="editForm" onsubmit="updateGender(event, {{ $call->id }})" style="padding: 20px;color: black;">
         @csrf
    ...
    let url = "{{ url('gender/store') }}"; // URL الخاص بالـ POST

...
<td>{{$call->tr_users_degree_desc}}</td>
    ...
    <div class="gf">
                ...
                <h4 class="h44">اضافة   درجة علمية جديدة </h4>

                </div>
        <form id="myForm" action="{{ url('grade/store') }}" method="post" enctype="multipart/form-data" style="padding: 20px;color: black;">
            @csrf
            <div class="roww">
        ...
        <div class="popup" id="popuppo-1">
         ...
         <div class="gf">
                ...
                <h4 class="h44">   تعديل الدرجة العلمية</h4>

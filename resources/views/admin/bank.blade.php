...
<td>   <a href=" updateSwitch/{{$call->id}}" class="btn btn-sm btn-{{$call->tr_bank_status ? 'success' : 'danger'}}">
    {{$call->tr_bank_status ? 'فعالة' : 'غير فعالة'}}
        ...
        <div class="popup" id="popup-1">
            ...
            <div class="content">
                ...
                <h4 class="h44">اضافة بنك  جديد</h4>

                </div>
                <!-- <div class="containerr"> -->
                <form id="myForm"  action="{{url('bank/store')}}" method="post" enctype="multipart/form-data" style="padding: 20px;color: black;">
                @csrf
                      <div class="roww">
    ...
    let url = "{{ url('bank/store') }}"; // URL الخاص بالـ POST
    ...
    fetch(`/bank/edit/${id}`)
        ...
        .then(data => {
            ...
            document.getElementById('bank_id').value = data.id; // ضبط معرف الكورس

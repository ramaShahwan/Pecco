...
.table-striped > tbody > tr:nth-child(odd) > td{
  ...
  <div id="page-wrapper" style="    height: 610px;
   ...
   @endif
    ...
    border: 1px solid rgb(109 177 188); box-shadow: 1px 1px 7px 0px rgb(109 177 188);">
    ...
    color: white;">
                            ...
                            <a href="{{url('user/create')}}" class="bbtn" target="_blank">  موظف جديد </a>
                            ...
                            @foreach($data as $call)
                                ...
                                <td>{{ $call->tr_user_name}} </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('user/edit',$call->id)}}" target="_blank"><span class="las la-edit" style="font-size: 30px; color: #3f4046;"></span></a>
                                        ...
                                        <a href="{{url('user/show',$call->id)}}" target="_blank"><span class="las la-eye" style="font-size: 30px; color: #1cda55;"></span></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>

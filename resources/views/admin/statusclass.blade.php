...
<td>{{$call->tr_class_status_desc}}</td>
        ...
        <div class="popup" id="popup-1">
            ...
            <div class="content">
                ...
                <h4 class="h44">اضافة حالة صف جديدة   </h4>

                </div>
                <!-- <div class="containerr"> -->
                <form id="myForm" action="{{url('class/store')}}" method="post" enctype="multipart/form-data" style="padding: 20px;color: black;">
                @csrf
                      <div class="roww">

                        <div class="input-groupp input-groupp-icon">
                        <div class="input-icon"><i class="fa-solid fa-signature"></i></div>
                        <input type="text" placeholder=" الاسم باللغة العربية" name="tr_class_status_name_ar" value="{{ old('tr_class_status_name_ar') }}" class="@error('tr_class_status_name_ar') is-invalid @enderror"/>
                      ...
                      <span class="invalid-feedback"></span>
                        ...
                        <div class="input-groupp input-groupp-icon">
                          <input type="text" placeholder="الاسم باللغة الانكليزية" name="tr_class_status_name_en" value="{{ old('tr_class_status_name_en') }}" class="@error('tr_class_status_name_en') is-invalid @enderror"/>
                          <div class="input-icon"><i class="fa-solid fa-signature"></i></div>
                      ...
                      <div class="roww">
                        ...
                        <div class="input-groupp" style="display: flex;">
                          <input id="icard" type="radio" name="tr_class_status" value="1" {{ old('tr_class_status') == '1' ? 'checked' : '' }}/>
                          <label for="icard"><span><i class="fa-solid fa-check"></i>فعالة</span></label>
                          <input id="ipaypal" type="radio" name="tr_class_status" value="0" {{ old('tr_class_status') == '0' ? 'checked' : '' }}/>
                          <label for="ipaypal"> <span><i class="fa-solid fa-xmark"></i>غير فعالة</span></label>
                          <span class="invalid-feedback"></span>

                        </div>
                        <div class="input-groupp input-groupp-icon">
                          <input type="text" placeholder="الوصف" name="tr_class_status_desc" value="{{ old('tr_class_status_desc') }}"/>
        ...
        <div class="popup" id="popuppo-1">
         ...
         <div class="gf">
                ...
                <h4 class="h44">  تعديل حالة الصف </h4>
    ...
    let url = "{{ url('class/store') }}"; // URL الخاص بالـ POST

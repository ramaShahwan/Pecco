...
@endif
        ...
        <div class="popup" id="popup-1">
            ...
            <div class="content">
               ...
               <h4 class="h44">اضافة ملف جديد  </h4>
                ...
                <form id="myForm" action="{{url('general_content/store')}}" method="post" enctype="multipart/form-data" style="padding: 20px;color: black;">
                @csrf
                      <div class="roww">
    ...
    let url = "{{ url('general_content/store') }}"; // URL الخاص بالـ POST

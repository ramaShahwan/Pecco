...
<td>
                                         <a href="{{url('bank_trainer/show_trainers_prog',$call->id)}}" target="_blank"><i class="fa-solid fa-user-plus" style="font-size: 20px; color: #3f4046;"></i></a>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('bank_ques/get_courses_for_prog',$call->id)}}" class="btn btn-sm" style="color: #686363; border-color: #686363;" target="_blank">open</a>

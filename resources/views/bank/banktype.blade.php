...
<td> <form action="{{ url('ques_type/updateSwitch/'.$call->id) }}" method="POST">
        ...
        <div class="popup" id="popup-1">
            ...
            <div class="content">
                ...
                <h4 class="h44">اضافة نوع بنك الاسئلة جديد  </h4>

                </div>
                <!-- <div class="containerr"> -->
                <form id="myForm" action="{{url('ques_type/store')}}" method="post" enctype="multipart/form-data" style="padding: 20px;color: black;">
                @csrf
                      <div class="roww">
                        <div class="input-groupp input-groupp-icon">
                            <div class="input-icon"><i class="fa-solid fa-signature"></i></div>
                          <input type="text" placeholder=" رمز محدد لنوع السؤال  " name="tr_questions_type_code" value="{{ old('tr_questions_type_code') }}" class="@error('tr_questions_type_code') is-invalid @enderror"/>
                      ...
                      <span class="invalid-feedback"></span>
                        ...
                        <div class="input-groupp input-groupp-icon">
                            <div class="input-icon"><i class="fa-solid fa-signature"></i></div>
                          <input type="text" placeholder=" اسم محدد لنوع السؤال  " name="tr_questions_type_name" value="{{ old('tr_questions_type_name') }}" class="@error('tr_questions_type_name') is-invalid @enderror"/>
                      ...
                      <span class="invalid-feedback"></span>
                        ...
                        <div class="input-groupp input-groupp-icon">
                          <input type="text" placeholder="توصيف محدد لنوع السؤال  " name="tr_questions_type_desc" value="{{ old('tr_questions_type_desc') }}" class="@error('tr_questions_type_desc') is-invalid @enderror"/>
                      ...
                      <div class="roww">
                        ...
                        <div class="input-groupp" style="display: flex;">
                          <input id="icard" type="radio" name="tr_questions_type_status" value="1" {{ old('tr_questions_type_status') == '1' ? 'checked' : '' }}/>
                          <label for="icard"><span><i class="fa-solid fa-check"></i>فعالة</span></label>
                          <input id="ipaypal" type="radio" name="tr_questions_type_status" value="0" {{ old('tr_questions_type_status') == '0' ? 'checked' : '' }}/>
        ...
        <div class="popup" id="popuppo-1">
         ...
         <div class="gf">
                ...
                <h4 class="h44">  تعديل نوع البنك الاسئلة </h4>
    ...
    let url = "{{ url('ques_type/store') }}"; // URL الخاص بالـ POST

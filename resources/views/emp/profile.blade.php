...
@endif
            ...
            <form action="  {{url('user/update_profile',$data->id)}}" method="Post" enctype="multipart/form-data" style="padding: 20px;color: black;">            @csrf
            @method('PUT')
...
<h4>الاسم بالعربي   </h4>
    ...
    display: inline-block;">
                      ...
                      @enderror
                        ...
                        <div class="input-groupp" style="width: 440px;margin-right: 74px;
    display: inline-block;">
       <h4> الجنس    </h4>

...
.ytt{
    ...
    /* padding: 20px; */
    box-sizing: border-box;
    box-shadow: inset 0px 1px 19px 1px #6082a5;
        }
        .popup .close-btn{
            cursor: pointer;
            position: absolute;
...
<p style="text-align: center; font-size: 16px;" class="text2">
 ...
 <script>
    ...
    function togglePopuox(){
        ...
        function togglePopuoxq(){
            document.getElementById("popupxq-1").classList.toggle("active");
        }
        function togglePopuoxqw(){
            document.getElementById("popupxqw-1").classList.toggle("active");
        }
         function togglePopuoxqwe(){
            document.getElementById("popupxqwe-1").classList.toggle("active");
        }
          function togglePopuoxqwer(){
            document.getElementById("popupxqwer-1").classList.toggle("active");
        }
           function togglePopuoxqwert(){
            document.getElementById("popupxqwert-1").classList.toggle("active");
        }
        function togglePopuoxqwerty(){
            document.getElementById("popupxqwerty-1").classList.toggle("active");
        }
        function togglePopuoxqwertyu(){
            document.getElementById("popupxqwertyu-1").classList.toggle("active");
        }
          function togglePopuoxqwertyui(){
            document.getElementById("popupxqwertyui-1").classList.toggle("active");
        }
          function togglePopuoxqwertyuio(){
            document.getElementById("popupxqwertyuio-1").classList.toggle("active");
        }
           function togglePopuoxqwertyuiop(){
            document.getElementById("popupxqwertyuiop-1").classList.toggle("active");
        }
</script>
...
<p style="    text-align: end;
    font-size: 20px;    margin-bottom: 15px;"><span class="ytt">فرع :</span>دمشق</p>
                ...
                <p class="text1" style="font-size: 15px;text-align: end; margin-top: 30px;">

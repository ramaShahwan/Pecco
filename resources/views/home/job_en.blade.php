...
<head>
    ...
    <link rel="stylesheet" href="assets/vendor/animate.css-master/animate.min.css">
...
.pri_table_listt h3 span {
  font-size: 16px;
}

.pri_table_listt ol li {
...
<body>
    ...
    <button class="next-card"><i class="fa-solid fa-forward"></i></button>
  </div>
                                       </div>
                                       <div class="card rounded-0 wow slideInDown mb-4 mb-lg-0"  data-wow-delay=".8s">

                                        <div class="pri_table_listt active">
...
<Script>
  ...
  // التنقل إلى البطاقة التالية عند الضغط على الزر

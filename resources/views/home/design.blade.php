        ...
        if (selectedRoute) {
            ...
            <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1 rr" id="navbar-example" style="padding:0px;">
              ...
              <li style="margin-left: 40px;">
                    <a class="page-scroll tt text1" href="#">تصميم داخلي وديكور</a>
                  </li>
                  <li style="margin-left: 40px;">
                    <a class="page-scroll tt text1" href="#">تدعيم</a>
                  </li>
                  <li style="margin-left: 40px;">
                    <a class="page-scroll tt text1" href="#">المخططات النقابية </a>
                  </li>
                  <li style="margin-left: 40px;">
            ...
            <div class="about-move rrr">
              <div class="services-details" style="background: #e2e7e4;border-radius: 20px; border: 1px solid #c3b9b9;box-shadow: 2px 1px 1px #a69d9d;        padding: 30px 0px 30px 0px;">
                <div class="single-services">
                  ...
                  <h4 class="text2">دراسات خارجية</h4>
                  <p style="font-size: 16px;"class="text11">
                    نحن ملتزمون بموصلة نمونا وتطورنا وتوسيع خدماتنا بالتعامل مع الشركات الهندسية الدولية وذلك بالاعتماد على فرق العمل الافتراضية والمنهجيات الحديثة في العمل الافتراضي
                  </p>
                </div>
              </div>
              <!-- end about-details -->
            ...
            <div class="about-move rrr">
              <div class="services-details" style="background: #e2e7e4;border-radius: 20px; border: 1px solid #c3b9b9;box-shadow: 2px 1px 1px #a69d9d;      padding: 30px 0px 30px 0px;">
                <div class="single-services">
                  ...
                  <h4 class="text2">تدعيم</h4>
                  <p style="font-size: 16px;"class="text11">
                    نقدم استشارات هندسية لتدعيم المباني ونقوم بدراسات تخص أعمال تدعيم المنشآت وذلك لتحقيق سلامة واستقرار المبنى نحن خبراء في تنفيذ حلول سريعة ومرنة  عند العمل
                  </p>
                </div>
              </div>
              <!-- end about-details -->
            ...
            <div class=" about-move rrr">
              <div class="services-details" style="background: #e2e7e4;border-radius: 20px; border: 1px solid #c3b9b9;box-shadow: 2px 1px 1px #a69d9d;       padding: 30px 0px 30px 0px;">
                <div class="single-services">
                  ...
                  <h4 class="text2">مخططات نقابية</h4>
                  <p style="font-size: 16px;"class="text11">
                    نقوم بإعداد المخططات الهندسية المطابقة لمعايير الجودة العالمية وتصديقها من نقابة المهندسين حيث تقوم هذه المعايير بارتقاء بالخدمات التي تقدمها الشركة بأعلى المستويات
                  </p>
                </div>
              </div>
              <!-- end about-details -->
            ...
            <div class=" about-move rrr">
              <div class="services-details" style="background: #e2e7e4;border-radius: 20px; border: 1px solid #c3b9b9;box-shadow: 2px 1px 1px #a69d9d;        padding: 30px 0px 30px 0px;">
                <div class="single-services">
                  ...
                  <h4 class="text2"> تصميم داخلي وديكور</h4>
                  <p style="font-size: 16px;" class="text11">
                  نقدم حلول متخصصة لتهيئة البيئة المثالية لمنزلك او مساحة عملك من الفكرة للتنفيذ وذلك من خلال
 مجموعة واسعة من الخدمات بما فيها التصميم الداخلي والخارجي   </p>
                </div>
              </div>
              <!-- end about-details -->
            </div>
        ...
        <div class="row">
            ...
            <div class="single-blog" style="border: 2px solid #7e7676; margin-top: 30px;border-radius: 30px;">
              ...
              <div class="blog-text">
                <h4 style="text-align: center;">
                                        <a href="#" class="text11">المشروع التاسع عشر   </a>
									</h4>
                <p style="text-align: center; font-size: 16px;" class="text2">
                  المشروع عبارة عن بناء فيلات وشقق سكانية منها 64 فيلا و93 شقة سكنية خاصة للمهندسين منها المنفصلة ومنها التوأمية
              </p>
              </div>
              <!-- <span>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog" style="border: 2px solid #7e7676; margin-top: 30px;border-radius: 30px;">
              ...
              <div class="blog-text">
                <h4 style="text-align: center;">
                                        <a href="#" class="text11">مشروع واحة المهندسين العراقيات    </a>
									</h4>
                <p style="text-align: center; font-size: 16px;"class="text2" >
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog" style="border: 2px solid #7e7676; margin-top: 30px;border-radius: 30px;">
              ...
              <div class="blog-text">
                <h4 style="text-align: center;">
                                        <a href="#" class="text11"> مشروع برج كورنيش دريمز</a>
									</h4>
                <p style="text-align: center; font-size: 16px;" class="text2">
                  إعادة تصميم وتخطيط وإدراة المشاريع يتكون البرج الايمن من 30 دور ويعد البرج الأطول من الأبراج المجاورة
                </p>
              </div>
              <!-- <span>
									<a href="blog.html" class="ready-btn">Read more</a>
...
<p style="    text-align: end;
    font-size: 20px;    margin-bottom: 15px;"><span class="ytt">فرع :</span>دمشق</p>
                ...
                <p style="font-size: 15px;text-align: end; margin-top: 30px;" class="text1">
